...
def reset_state():
    global dataset, index, total_images, image_dir, label_dir, current_annotations, start_x, start_y, selected_boxes, classes, class_colors, current_class_id, contrast_index, current_shape, class_info_window, class_selection_window, low_quality
    dataset = []
    index = 0
    total_images = 0
    image_dir = ''
...
root.bind("R", lambda e: refresh_display())
root.bind("r", lambda e: refresh_display())
