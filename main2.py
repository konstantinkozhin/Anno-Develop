...
directory_label = tk.Label(directory_frame, text="Дирректория с изображениями:")
directory_label.pack(side=tk.LEFT)
directory_button = tk.Button(directory_frame, text="Загрузить", command=load_dataset)
...
info_label = tk.Label(info_frame, text="Всего изображений: 0")
info_label.pack()

nav_frame = tk.Frame(frame)
nav_frame.pack(fill=tk.X, **style)

previous_button = tk.Button(nav_frame, text="Назад", command=previous_image)
previous_button.pack(side=tk.LEFT)
next_button = tk.Button(nav_frame, text="Вперед", command=next_image)
next_button.pack(side=tk.RIGHT)
annotate_button = tk.Button(nav_frame, text="Аннотировать", command=annotate_image)
annotate_button.pack(side=tk.RIGHT, padx=5)

annotation_frame = tk.Frame(frame)
annotation_frame.pack(fill=tk.BOTH, **style)

annotation_label = tk.Label(annotation_frame, text="Координаты:")
