...
def reset_state():
    global dataset, index, total_images, image_dir, label_dir, current_annotations, start_x, start_y, selected_boxes, classes, class_colors, current_class_id, contrast_index
    dataset = []
    index = 0
    total_images = 0
    image_dir = ''
...
image_number_entry = ttk.Entry(counter_frame, width=5)
